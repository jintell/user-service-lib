...
import org.meldtech.platform.model.api.request.signin.SignInRequest;
import org.meldtech.platform.model.security.UsernamePasswordToken;
...
import static org.meldtech.platform.model.constant.AppConstant.*;
...
//    @Value("${tima.iv}")
    ...
    protected Mono<AppResponse> getAccessToken(UsernamePasswordToken credentials) throws AppException {
        ...
        return connectorService.postForm(authServerUrl, formData, headers(formData), AccessToken.class)
                ...
                .map(accessToken -> appResponse(accessToken, USER_ACCOUNT_MSG));
    }
