package org.meldtech.platform.model.constant;
...
public interface AppConstant {
    ...
    String PATTERN_1 = "\"@class\":|\"java.util.Collections\\$UnmodifiableMap\",";
    String PATTERN_2 = "\"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat\",\"value\":\"self-contained\"";
    String PATTERN_3 = "\"java.time.Duration\",";
    String PATTERN = String.format("(%s)+|(%s)+|(%s)+", PATTERN_1, PATTERN_2, PATTERN_3);
