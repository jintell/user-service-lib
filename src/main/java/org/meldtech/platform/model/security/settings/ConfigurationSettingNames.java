...
public class ConfigurationSettingNames {
    ...
    public static final class AuthorizationServer {
        ...
        static {
            ...
            MULTIPLE_ISSUERS_ALLOWED = AUTHORIZATION_SERVER_SETTINGS_NAMESPACE.concat("multiple-issuers-allowed");
    ...
    public static final class Client {
        ...
        static {
            ...
            X509_CERTIFICATE_SUBJECT_DN = CLIENT_SETTINGS_NAMESPACE.concat("x509-certificate-subject-dn");
        }
    }
}
